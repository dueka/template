  ...
  return (
    <div style={{ paddingBottom: "6rem" }}>
      <div className="project-column" style={{ paddingBottom: "1rem" }}>
        ...
        <div
          className="project-column__category"
        ...
        <div className="project-column__funding">
          <div className="project-column__filter-body">
            <div className="project-column__filter-body-text">
              <p className="body-text-5-semibold">Filter by funding status</p>
            </div>
            <div className="project-column__filter-icon">
              <CaretDown />
            </div>
...
export default AgentProjectsColumn;
